...
function Navbar({ setIsActive, setIsOpenMainMenu, isOpenMainMenu }) {
  ...
  const { isActive, countCart } = useContext(MyContext);
                  ...
                  <ul className="grid grid-cols-[repeat(4,max-content)] gap-x-4 justify-end">
                    ...
                    <li className="relative">
                      <Link>
                        ...
                        <span className="absolute w-max h-max bottom-4 -right-3 text-center rounded-full text-sm bg-green-600 text-white font-bold px-[.4rem]">{countCart !== 0 && countCart}</span>
                      </Link>
                    </li>
                    <li>
