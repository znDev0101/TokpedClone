...
function NavbarOnProductDetail({ style, handleClick }) {
  return (
    <div className={style}>
      ...
      <Button textButton={'+Keranjang'} styleButton={'w-full font-bold text-white py-2 bg-green-500 rounded-md'} handleClick={handleClick} />
    </div>
  );
}
