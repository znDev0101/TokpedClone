...
const MainMenu = ({ isOpenMainMenu, setIsOpenMainMenu, pathname }) => {
  return (
    <>
      <div
        className={isOpenMainMenu ? `w-full absolute top-0 bottom-0 left-0 right-0 h-screen bg-white z-50 duration-300 translate-y-0` : `w-full absolute top-0 bottom-0 left-0 right-0 h-screen  bg-white z-50 duration-300 translate-y-full`}
      >
